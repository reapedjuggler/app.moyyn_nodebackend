...
router.post('/register' ,function(req, res, next) {
  ...
  var cvEnglish =data[1].cvEnglish[0];
  var cvGerman =data[1].cvGerman[0] || "File Not uploaded";

  let decodedBase64German = base64.base64Decode(cvEnglish.data, "../cvData/German_CV/"+cvGerman.file);
  let decodedBase64English = base64.base64Decode(cvGerman.data, "../cvData/English_CV/"+cvEnglish.file);

  console.log(cvGerman.data);

  fs.writeFile("../cvData/German_CV/"+cvGerman.file, decodedBase64German, function(err) {
    if(err) {
  ...
  fs.writeFile("../cvData/English_CV/"+cvEnglish.file, decodedBase64English, function(err) {
  if(err) {
      return console.log(err);
  }
